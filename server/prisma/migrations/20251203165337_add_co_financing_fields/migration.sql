...
INSERT INTO "new_TrainingRequest" ("actual_end_date", "actual_start_date", "campaign_id", "cost", "cost_type", "created_at", "department_id", "description", "duration_days", "end_date", "id", "manager_expectations", "manager_id", "provider_id", "start_date", "status", "title", "type", "updated_at", "user_id") SELECT "actual_end_date", "actual_start_date", "campaign_id", "cost", "cost_type", "created_at", "department_id", "description", "duration_days", "end_date", "id", "manager_expectations", "manager_id", "provider_id", "start_date", "status", "title", "type", "updated_at", "user_id" FROM "TrainingRequest";
